  ...
  return (
    ...
    <div className="calculator-app">
      ...
      <button className='top' onClick={() => dispatch({ type: 'remove' })}>
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-backspace" width="48" height="48" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
